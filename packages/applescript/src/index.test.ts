...
describe("executeArcJavaScript", () => {
  ...
  test("should execute JavaScript that returns JSON", async () => {
    ...
    // Result is auto-parsed from JSON string to object
  ...
  test("should execute JavaScript that returns an array", async () => {
    ...
    // Result is auto-parsed from JSON string to array
  ...
  test("should execute code with special characters", async () => {
    const result = await executeArcJavaScript(
      "JSON.stringify({ quote: '\\\"test\\\"', newline: '\\\\n' })"
    );
    // Result is auto-parsed from JSON string to object
    expect(typeof result).toBe("object");
    expect(result.quote).toContain("test");
  });
